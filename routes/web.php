...
/*
|--------------------------------------------------------------------------
| Telegram Webhook Route (CSRF Disabled)
|--------------------------------------------------------------------------
| Route này phải được thêm vào app/Http/Middleware/VerifyCsrfToken.php
| trong mảng $except: '/webhook/telegram'
*/
...
Route::match(['get', 'post'], '/webhook/telegram', function (Request $request) {
    ...
    try {
        ...
        // FIX: Thêm return statement để tránh lỗi 500
        return response()->json([
            'ok' => false,
...
/*
|--------------------------------------------------------------------------
| Telegram Setup Routes (Optional - for admin use)
|--------------------------------------------------------------------------
*/
